...
const i18n = {
    fa: {
        ...
        news_all: 'همه', news_crypto: 'کریپتو', news_economy: 'اقتصادی', news_forex: 'فارکس', news_calendar: 'تقویم', news_saved: 'ذخیره شده',
        ...
        mem_benefit_daily_desc: 'پاداش روزانه AB با چک‌این هر روز',
        ...
        // I18N FIX: Persian translations for previously hardcoded English strings
        adm_tk_no_tickets: 'تیکتی یافت نشد',
        adm_tk_load_error: 'بارگذاری تیکت‌ها انجام نشد',
        adm_tk_reply_empty: 'پاسخ نمی‌تواند خالی باشد',
        adm_tk_reply_too_long: 'پاسخ بیش از حد طولانی است (حداکثر ۱۵۰۰ کاراکتر)',
        adm_tk_reply_sent: 'پاسخ ارسال شد',
        adm_tk_reply_failed: 'ارسال پاسخ ناموفق بود',
        adm_tk_status_updated: 'وضعیت به‌روزرسانی شد',
        adm_tk_status_update_failed: 'به‌روزرسانی وضعیت ناموفق بود',
        adm_tk_deleted: 'تیکت حذف شد',
        adm_tk_delete_failed: 'حذف تیکت ناموفق بود',
        adm_no_admins: 'ادمینی یافت نشد',
        adm_admins_load_error: 'بارگذاری ادمین‌ها انجام نشد',
        adm_admin_status_updated: 'وضعیت ادمین به‌روزرسانی شد',
        adm_admin_removed: 'ادمین حذف شد',
        adm_no_users: 'کاربری یافت نشد',
        adm_users_load_error: 'بارگذاری کاربران انجام نشد',
        adm_joined: 'عضو شده',
        adm_not_joined: 'عضو نشده',
        adm_no_broadcasts: 'پیامی یافت نشد',
        adm_broadcasts_load_error: 'بارگذاری پیام‌ها انجام نشد',
        adm_refund_pending: 'در انتظار',
        adm_refund_approved: 'تأیید شده',
        adm_refund_delivered: 'تحویل شده',
        adm_refund_rejected: 'رد شده',
        adm_broadcast_sent: 'پیام ارسال شد',
        adm_broadcast_send_failed: 'ارسال پیام ناموفق بود'
    },
    en: {
        ...
        news_all: 'All', news_crypto: 'Crypto', news_economy: 'Economy', news_forex: 'Forex', news_calendar: 'Calendar', news_saved: 'Saved',
        ...
        jl_checking: 'Checking membership status...',
        jl_wait: 'Please wait a moment.',
        jl_join_channel: 'Join Channel',
        jl_verify: 'Verify Membership',
        ...
        mem_benefit_daily_desc: 'Daily AB rewards through your streak',
        ...
        // I18N FIX: English fallbacks for previously hardcoded strings
        adm_tk_no_tickets: 'No tickets found',
        adm_tk_load_error: 'Failed to load tickets',
        adm_tk_reply_empty: 'Reply cannot be empty',
        adm_tk_reply_too_long: 'Reply too long (max 1500 chars)',
        adm_tk_reply_sent: 'Reply sent',
        adm_tk_reply_failed: 'Failed to send reply',
        adm_tk_status_updated: 'Status updated',
        adm_tk_status_update_failed: 'Failed to update status',
        adm_tk_deleted: 'Ticket deleted',
        adm_tk_delete_failed: 'Failed to delete ticket',
        adm_no_admins: 'No admins found',
        adm_admins_load_error: 'Failed to load admins',
        adm_admin_status_updated: 'Admin status updated',
        adm_admin_removed: 'Admin removed',
        adm_no_users: 'No users found',
        adm_users_load_error: 'Failed to load users',
        adm_joined: 'Joined',
        adm_not_joined: 'Not joined',
        adm_no_broadcasts: 'No broadcasts yet',
        adm_broadcasts_load_error: 'Failed to load broadcasts',
        adm_refund_pending: 'Pending',
        adm_refund_approved: 'Approved',
        adm_refund_delivered: 'Delivered',
        adm_refund_rejected: 'Rejected',
        adm_broadcast_sent: 'Broadcast sent successfully',
