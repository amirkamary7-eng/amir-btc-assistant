...
const WalletApp = (() => {
  ...
  // are now loaded from shared-utils.js (loaded before wallet.js).
  // displayTier remains here (uses WT() which is wallet-specific).
  ...
  // formatNumber is now loaded from shared-utils.js (loaded before wallet.js)
