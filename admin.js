    ...
    return '<div class="rc-card" style="border-color:rgba(245,166,35,0.3);">' +
        ...
        '<div class="rc-form-grid">' +
            ...
            '<div class="rc-field"><label>مخاطب هدف</label>' +
                ...
                '<label class="rc-toggle-row"><input type="radio" name="ads-msg-aud" value="all" ' + radioChecked('all', currentAud) + '><span>همه کاربران (رایگان + Premium با تبلیغات فعال)</span></label>' +
            '</div>' +
