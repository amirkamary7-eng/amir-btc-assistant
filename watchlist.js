...
(function() {
    ...
    if (typeof window.addToWatchlist === 'undefined') {
        window.addToWatchlist = function(symbol) {
            ...
            if (!list.includes(symbol)) {
                ...
                if (typeof window.closeAddCoinModal === 'function') window.closeAddCoinModal();
            }
        };
    }
    ...
    if (typeof window.openAddCoinModal === 'undefined') {
        window.openAddCoinModal = function() {
            const modal = document.getElementById('add-coin-modal');
            if (modal) {
                modal.style.display = 'flex';
                if (typeof window.populateAddCoinModal === 'function') window.populateAddCoinModal();
            }
        };
    }
